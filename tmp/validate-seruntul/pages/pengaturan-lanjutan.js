...
Waktu: ${(/* @__PURE__ */ new Date()).toLocaleString("id-ID")}`
  ...
  return /* @__PURE__ */ jsxs(AppLayout, { title: "Pengaturan Lanjutan", subtitle: "Legal, pengiriman, notifikasi, dan user", children: [
    ...
    tab === "legal" && /* @__PURE__ */ jsxs("div", { className: "card", children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "text-sm text-muted mb-3", children: "Data ini dipakai untuk keperluan administrasi, label produk, dan pengajuan izin." }),
      /* @__PURE__ */ jsx("div", { className: "grid-2", children: LEGAL_FIELDS.map((f) => /* @__PURE__ */ jsxs("div", { className: "form-group", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsx("button", { className: "btn btn-primary", onClick: () => simpanSemua("legal_config", LEGAL_FIELDS), disabled: saving, children: saving ? /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx("span", { className: "spinner" }),
        " Menyimpan..."
      ] }) : "\u{1F4BE} Simpan" }) })
    ] }),
    tab === "kirim" && /* @__PURE__ */ jsxs("div", { className: "card", children: [
      /* @__PURE__ */ jsx("div", { className: "card-header", children: /* @__PURE__ */ jsxs("div", { className: "card-title", children: [
        /* @__PURE__ */ jsx("span", { className: "nav-icon", children: "\u{1F69A}" }),
        " Biaya Kirim / Ongkir"
      ] }) }),
      /* @__PURE__ */ jsx("div", { className: "form-row", children: KIRIM_CONFIG.map((f) => /* @__PURE__ */ jsxs("div", { className: "form-group", children: [
        /* @__PURE__ */ jsx("label", { className: "form-label", children: f.l }),
        /* @__PURE__ */ jsx(
          "input",
          {
      ...
      val("biaya_kirim") !== "" && /* @__PURE__ */ jsxs("div", { className: "alert alert-info", children: [
        "Contoh: pesan ",
        rp(5e4),
        ", ongkir ",
        rp(val("biaya_kirim")),
        ".",
        " ",
        Number(val("biaya_kirim_gratis_min")) > 0 && Number(val("biaya_kirim_gratis_min")) <= 5e4 ? "Belanja Rp50.000 sudah GRATIS ONGKIR." : `Gratis ongkir mulai ${rp(val("biaya_kirim_gratis_min"))}.`
      ] }),
      /* @__PURE__ */ jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsx("button", { className: "btn btn-primary", onClick: () => simpanSemua("configuration", KIRIM_CONFIG), disabled: saving, children: saving ? /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx("span", { className: "spinner" }),
        " Menyimpan..."
      ] }) : "\u{1F4BE} Simpan" }) })
    ] }),
    tab === "notif" && /* @__PURE__ */ jsxs("div", { className: "card", children: [
      /* @__PURE__ */ jsx("div", { className: "card-header", children: /* @__PURE__ */ jsxs("div", { className: "card-title", children: [
        /* @__PURE__ */ jsx("span", { className: "nav-icon", children: "\u{1F4AC}" }),
        " Notifikasi WhatsApp (Fonnte)"
      ] }) }),
      /* @__PURE__ */ jsxs("p", { className: "text-sm text-muted mb-3", children: [
        "Kirim notifikasi otomatis ke WhatsApp Anda: stok menipis, produk mendekati kedaluwarsa, atau target tercapai. Layanan pihak ketiga ",
        /* @__PURE__ */ jsx("b", { children: "Fonnte" }),
        " dipakai untuk pengiriman."
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "form-row", children: [
        /* @__PURE__ */ jsxs("div", { className: "form-group", children: [
          /* @__PURE__ */ jsx("label", { className: "form-label", children: "Status Notifikasi" }),
          /* @__PURE__ */ jsxs("select", { className: "form-control", value: val("notif.wa_aktif") || "false", onChange: (e) => setLokal("notif.", "wa_aktif", e.target.value), children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "form-group", style: { flex: 2 }, children: [
          /* @__PURE__ */ jsx("label", { className: "form-label", children: "Token API Fonnte" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              className: "form-control",
          ...
          /* @__PURE__ */ jsx("div", { className: "text-xs text-muted mt-1", children: "Login fonnte.com \u2192 Device \u2192 salin Token" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "form-group", children: [
          /* @__PURE__ */ jsx("label", { className: "form-label", children: "Nomor WA Admin" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              className: "form-control",
      ...
      /* @__PURE__ */ jsx("div", { className: "form-row", children: NOTIF_FIELDS.filter((f) => f.k.startsWith("notif_")).map((f) => /* @__PURE__ */ jsxs("div", { className: "form-group", children: [
        /* @__PURE__ */ jsx("label", { className: "form-label", children: f.l }),
        /* @__PURE__ */ jsxs("select", { className: "form-control", value: val(`notif.${f.k}`) || "false", onChange: (e) => setLokal("notif.", f.k, e.target.value), children: [
          /* @__PURE__ */ jsx("option", { value: "true", children: "Aktif" }),
          /* @__PURE__ */ jsx("option", { value: "false", children: "Nonaktif" })
        ] })
      ] }, f.k)) }),
      tesStatus && /* @__PURE__ */ jsx("div", { className: "alert alert-info", children: tesStatus }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-2 justify-end", children: [
        /* @__PURE__ */ jsx("button", { className: "btn btn-outline", onClick: tesWA, children: "\u{1F514} Tes Kirim WA" }),
        /* @__PURE__ */ jsx("button", { className: "btn btn-primary", onClick: () => simpanSemua("notification_config", NOTIF_FIELDS), disabled: saving, children: saving ? /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx("span", { className: "spinner" }),
          " Menyimpan..."
        ] }) : "\u{1F4BE} Simpan" })
      ] })
    ] }),
    tab === "user" && /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx("form", { onSubmit: tambahAkunLogin, children: /* @__PURE__ */ jsxs("div", { className: "card", children: [
        /* @__PURE__ */ jsx("div", { className: "card-header", children: /* @__PURE__ */ jsxs("div", { className: "card-title", children: [
          /* @__PURE__ */ jsx("span", { className: "nav-icon", children: "\u{1F464}" }),
          " Tambah Akun Login"
        ] }) }),
        /* @__PURE__ */ jsxs("p", { className: "text-sm text-muted mb-3", children: [
          "Akun yang dibuat di sini ",
          /* @__PURE__ */ jsx("b", { children: "langsung bisa login" }),
          " \u2014 tidak perlu buka Supabase lagi."
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "form-row", children: [
          /* @__PURE__ */ jsxs("div", { className: "form-group", style: { flex: 2 }, children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "pw-wrap", children: [
              ...
              /* @__PURE__ */ jsx(
                "button",
                {
                  ...
                  children: userBaru.lihat ? "\u{1F648}" : "\u{1F441}\uFE0F"
                }
              )
            ] })
          ] })
        ...
        /* @__PURE__ */ jsxs("div", { className: "form-row", children: [
          /* @__PURE__ */ jsxs("div", { className: "form-group", children: [
            ...
            /* @__PURE__ */ jsx("input", { className: "form-control", value: userBaru.nama, onChange: (e) => setUserBaru({ ...userBaru, nama: e.target.value }), placeholder: "Nama karyawan" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "form-group", children: [
            /* @__PURE__ */ jsx("label", { className: "form-label", children: "Role" }),
            /* @__PURE__ */ jsxs("select", { className: "form-control", value: userBaru.role, onChange: (e) => setUserBaru({ ...userBaru, role: e.target.value }), children: [
              /* @__PURE__ */ jsx("option", { value: "owner", children: "Owner \u2014 akses penuh" }),
              /* @__PURE__ */ jsx("option", { value: "admin", children: "Admin" }),
              /* @__PURE__ */ jsx("option", { value: "kasir", children: "Kasir" }),
              /* @__PURE__ */ jsx("option", { value: "produksi", children: "Produksi" }),
              /* @__PURE__ */ jsx("option", { value: "user", children: "User" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsx("button", { type: "submit", className: "btn btn-primary", disabled: prosesUser, children: prosesUser ? /* @__PURE__ */ jsxs(Fragment, { children: [
          /* @__PURE__ */ jsx("span", { className: "spinner" }),
          " Membuat..."
        ] }) : "\uFF0B Buat Akun" }) })
      ] }) }),
      editUser && /* @__PURE__ */ jsxs("div", { className: "card", style: { border: "2px solid var(--primary)" }, children: [
        /* @__PURE__ */ jsxs("div", { className: "card-header", children: [
          ...
          /* @__PURE__ */ jsx("button", { className: "btn btn-sm btn-outline", onClick: () => setEditUser(null), children: "\u2715" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "form-row", children: [
          /* @__PURE__ */ jsxs("div", { className: "form-group", children: [
            /* @__PURE__ */ jsx("label", { className: "form-label", children: "Email" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "form-group", children: [
          /* @__PURE__ */ jsx("label", { className: "form-label", children: "Password Baru (biarkan kosong kalau tidak diganti)" }),
          /* @__PURE__ */ jsxs("div", { className: "pw-wrap", children: [
            /* @__PURE__ */ jsx(
              "input",
              {
            ...
            /* @__PURE__ */ jsx(
              "button",
              {
                ...
                children: editUser.lihat ? "\u{1F648}" : "\u{1F441}\uFE0F"
              }
            )
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex gap-2 justify-end", children: [
          /* @__PURE__ */ jsx("button", { className: "btn btn-outline", onClick: () => setEditUser(null), children: "Batal" }),
          /* @__PURE__ */ jsx("button", { className: "btn btn-primary", onClick: simpanEditUser, disabled: prosesUser, children: prosesUser ? /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsx("span", { className: "spinner" }),
            " Menyimpan..."
      ...
      /* @__PURE__ */ jsxs("div", { className: "card", style: { padding: 0 }, children: [
        /* @__PURE__ */ jsxs("div", { className: "card-header", style: { padding: 16 }, children: [
          /* @__PURE__ */ jsxs("div", { className: "card-title", children: [
            /* @__PURE__ */ jsx("span", { className: "nav-icon", children: "\u{1F511}" }),
            " Akun Login"
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("span", { className: "text-sm text-muted", children: Array.isArray(authUsers) ? `${authUsers.length} akun` : "\u2014" }),
            /* @__PURE__ */ jsx("button", { className: "btn btn-sm btn-outline", onClick: muatAkunLogin, children: "\u{1F504} Muat Ulang" })
          ] })
        ] }),
        authUsers?.error ? /* @__PURE__ */ jsxs("div", { className: "alert alert-warning", style: { margin: 16 }, children: [
          "\u26A0\uFE0F ",
          authUsers.error,
          /* @__PURE__ */ jsx("br", {}),
          /* @__PURE__ */ jsxs("span", { className: "text-xs", children: [
            ...
            " sudah diset di Vercel \u2192 Settings \u2192 Environment Variables."
          ] })
        ] }) : !Array.isArray(authUsers) ? /* @__PURE__ */ jsx("p", { className: "text-muted text-center py-4", children: "Memuat akun..." }) : authUsers.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "empty-state", children: [
          /* @__PURE__ */ jsx("div", { className: "nav-icon", style: { fontSize: 40 }, children: "\u{1F464}" }),
          /* @__PURE__ */ jsx("h3", { children: "Belum ada akun" })
          ...
          /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { children: [
            ...
            /* @__PURE__ */ jsx("th", { children: "Login Terakhir" }),
            /* @__PURE__ */ jsx("th", { children: "Status" }),
            /* @__PURE__ */ jsx("th", {})
          ] }) }),
          /* @__PURE__ */ jsx("tbody", { children: authUsers.map((u) => {
            ...
            return /* @__PURE__ */ jsxs("tr", { children: [
              /* @__PURE__ */ jsxs("td", { className: "font-bold", children: [
                u.email,
                diriSendiri && /* @__PURE__ */ jsx("span", { className: "badge badge-info", style: { marginLeft: 6 }, children: "Anda" })
              ] }),
              /* @__PURE__ */ jsx("td", { children: u.nama || info?.nama || "\u2014" }),
              /* @__PURE__ */ jsx("td", { children: /* @__PURE__ */ jsx(
                "select",
                {
                  ...
                  children: ["owner", "admin", "kasir", "produksi", "user"].map((r) => /* @__PURE__ */ jsx("option", { value: r, children: r }, r))
                }
              ) }),
              /* @__PURE__ */ jsx("td", { className: "text-muted text-sm", children: u.login_terakhir ? new Date(u.login_terakhir).toLocaleString("id-ID", { day: "numeric", month: "short", hour: "2-digit", minute: "2-digit" }) : "belum pernah" }),
              /* @__PURE__ */ jsx("td", { children: /* @__PURE__ */ jsx("span", { className: `badge ${u.terkonfirmasi ? "badge-success" : "badge-warning"}`, children: u.terkonfirmasi ? "Aktif" : "Belum aktif" }) }),
              /* @__PURE__ */ jsx("td", { className: "text-right", children: /* @__PURE__ */ jsxs("div", { className: "flex gap-1 justify-end", children: [
                ...
                !diriSendiri && /* @__PURE__ */ jsx("button", { className: "btn btn-sm btn-danger", onClick: () => hapusAkunLogin(u), children: "\u2715" })
              ] }) })
            ] }, u.id);
          }) })
        ] }) })
    ...
    tab === "sistem" && /* @__PURE__ */ jsxs("div", { className: "card", children: [
      /* @__PURE__ */ jsx("div", { className: "card-header", children: /* @__PURE__ */ jsxs("div", { className: "card-title", children: [
        /* @__PURE__ */ jsx("span", { className: "nav-icon", children: "\u{1F6E0}\uFE0F" }),
        " Sistem & Sinkronisasi"
      ] }) }),
      /* @__PURE__ */ jsxs("div", { className: "sys-row", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "font-bold", children: "\u2601\uFE0F Penyimpanan Cloud" }),
          /* @__PURE__ */ jsx("div", { className: "text-sm text-muted", children: "Semua data tersimpan otomatis di Supabase (cloud), bukan di laptop. Laptop mati atau ganti perangkat tidak menghilangkan data \u2014 cukup login dengan akun yang sama." })
        ] }),
        /* @__PURE__ */ jsx("span", { className: "badge badge-success", children: "Aktif" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "sys-row", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "font-bold", children: "\u{1F510} Keamanan Data" }),
          /* @__PURE__ */ jsx("div", { className: "text-sm text-muted", children: "Akses database dikunci dengan Row Level Security: hanya pengguna yang sudah login yang bisa membaca & menulis." })
        ] }),
        /* @__PURE__ */ jsx("span", { className: "badge badge-success", children: "Aktif" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "sys-row", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "font-bold", children: "\u{1F4BE} Backup Manual" }),
          /* @__PURE__ */ jsx("div", { className: "text-sm text-muted", children: "Unduh salinan data penting (produk, transaksi, pelanggan) dalam format Excel untuk arsip pribadi." })
        ] }),
        /* @__PURE__ */ jsx("button", { className: "btn btn-sm btn-outline", onClick: () => exportBackup(), children: "\u2B07\uFE0F Unduh Backup" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "sys-row", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "font-bold", children: "\u{1F4F1} Akses Mobile" }),
          /* @__PURE__ */ jsxs("div", { className: "text-sm text-muted", children: [
            "Buka ",
            /* @__PURE__ */ jsx("b", { children: "seruntoel.vercel.app" }),
            ' di HP, lalu pilih "Tambahkan ke Home Screen" agar seperti aplikasi.'
          ] })
        ] }),
        /* @__PURE__ */ jsx("span", { className: "badge badge-info", children: "Siap" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "sys-row", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("div", { className: "font-bold", children: "\u{1F504} Versi Aplikasi" }),
          /* @__PURE__ */ jsx("div", { className: "text-sm text-muted", children: "Seruntul Advanced \xB7 Next.js + Supabase" })
        ] }),
        /* @__PURE__ */ jsx("span", { className: "badge badge-neutral", children: "v1.0" })
      ] })
    ] }),
