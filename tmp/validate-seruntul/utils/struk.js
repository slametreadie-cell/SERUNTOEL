...
const tglID = (d) => new Date(d || Date.now()).toLocaleString("id-ID", {
  day: "2-digit",
  month: "2-digit",
  year: "numeric",
  hour: "2-digit",
...
export function cetakStruk(trx, opts = {}) {
  ...
  const footer = t.footer_struk || "Terima kasih telah berbelanja \u{1F64F}";
...
<body><div class="wrap">
  ...
  <div class="actions">
    <button onclick="window.print()">\u{1F5A8}\uFE0F Cetak</button>
